...
export const ApiExplorer: React.FC = () => {
  ...
  const presets = [
    { label: "Check Identity (/me)", method: "GET", path: "/api/v1/auth/me", body: "" },
    {
      ...
      body: JSON.stringify({ username: "LordCaptain", password: "TestP@ss123" }, null, 2),
    },
    {
      label: "Login (Arch Magos)",
      method: "POST",
      path: "/api/v1/auth/login",
      body: JSON.stringify({ username: "ArchMagos", password: "TestP@ss123" }, null, 2),
    },
    {
      label: "Login (Servitor)",
      method: "POST",
      path: "/api/v1/auth/login",
      body: JSON.stringify({ username: "Servitor", password: "TestP@ss123" }, null, 2),
    },
