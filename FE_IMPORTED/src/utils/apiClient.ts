...
export class ApiClient {
  private static token: string | null = localStorage.getItem('rt_access_token');
  ...
  // Colonies
  static async getColonies(): Promise<any[]> {
  ...
  static async getColony(id: string | number): Promise<any> {
  ...
  static async createColony(payload: Partial<Colony>): Promise<any> {
  ...
  static async updateColony(id: string | number, payload: Partial<Colony>): Promise<any> {
  ...
  static async deleteColony(id: string | number): Promise<void> {
    const res = await fetch(`${API_BASE}/colonies/${id}`, {
      method: 'DELETE',
      headers: this.getHeaders(),
    });
  ...
  static async advanceColonyAge(id: string | number, days: number): Promise<any> {
  ...
  static async createRepresentative(payload: Partial<Representative>): Promise<Representative> {
  ...
  static async updateRepresentative(id: string | number, payload: Partial<Representative>): Promise<Representative> {
  ...
  static async deleteRepresentative(id: string | number): Promise<void> {
    const res = await fetch(`${API_BASE}/representatives/${id}`, {
      method: 'DELETE',
      headers: this.getHeaders(),
    });
  ...
  static async assignRepresentative(repId: string | number, colonyId: string | number | null): Promise<any> {
  ...
  static async updateInfrastructure(infraId: string | number, state: string, notes?: string): Promise<any> {
  ...
  static async createSupportUpgrade(colonyId: string | number, payload: Partial<SupportUpgradeItem>): Promise<any> {
  ...
  static async deleteSupportUpgrade(upgradeId: string | number): Promise<void> {
  ...
  // Roll Status & Events
  static async getRollStatus(colonyId: string | number): Promise<any> {
  ...
  static async getColonyEvents(colonyId: string | number): Promise<any[]> {
  ...
  static async createColonyEvent(colonyId: string | number, name: string, description?: string): Promise<any> {
  ...
  // Modifiers
  static async addModifier(colonyId: string | number, modifier: Partial<ModifierItem>): Promise<any> {
  ...
  static async deleteModifier(colonyId: string | number, modifierId: string | number): Promise<void> {
  ...
  // Development Plans
  static async createDevelopmentPlan(colonyId: string | number, plan: Partial<DevelopmentPlanItem>): Promise<any> {
  ...
  static async promoteDevelopmentPlan(planId: string | number): Promise<any> {
  ...
  // Export / Import
  static async exportColony(colonyId: string | number): Promise<any> {
  ...
  static async importColony(payload: any): Promise<any> {
  ...
  // Audit Logs
  static async getAuditLogs(colonyId?: string | number): Promise<any[]> {
