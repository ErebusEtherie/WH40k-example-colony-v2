...
class TestUsersAPI:
    ...
    def test_list_users_admin_only(self, auth_client: TestClient):
        ...
        user_data = {"username": "regularuser", "email": "regular@example.com", "password": "TestPass123!"}
    ...
    def test_get_user_by_id(self, auth_client: TestClient):
        ...
        user_data = {"username": "getuser", "email": "getuser@example.com", "password": "TestPass123!"}
    ...
    def test_update_user(self, auth_client: TestClient):
        ...
        # Create a user
        user_data = {"username": "updateuser", "email": "updateuser@example.com", "password": "TestPass123!"}
        create_response = auth_client.post("/api/v1/auth/register", json=user_data)
        user_id = create_response.json()["id"]
    ...
    def test_delete_user_soft_delete(self, auth_client: TestClient):
        ...
        # Create a user
        user_data = {"username": "deleteuser", "email": "deleteuser@example.com", "password": "TestPass123!"}
        create_response = auth_client.post("/api/v1/auth/register", json=user_data)
        user_id = create_response.json()["id"]
    ...
    def test_reset_password(self, auth_client: TestClient):
        ...
        # Create a user
        user_data = {"username": "resetuser", "email": "resetuser@example.com", "password": "OldPass123!"}
        create_response = auth_client.post("/api/v1/auth/register", json=user_data)
        user_id = create_response.json()["id"]
    ...
    def test_create_user_duplicate_username(self, auth_client: TestClient):
        ...
        # Create first user
        user_data1 = {"username": "duplicateuser", "email": "dup1@example.com", "password": "TestPass123!"}
        auth_client.post("/api/v1/auth/register", json=user_data1)
        
        # Try to create duplicate
        user_data2 = {"username": "duplicateuser", "email": "dup2@example.com", "password": "TestPass123!"}
    ...
    def test_create_user_duplicate_email(self, auth_client: TestClient):
        ...
        # Create first user
        user_data1 = {"username": "dupemail1", "email": "dupemail@example.com", "password": "TestPass123!"}
        auth_client.post("/api/v1/auth/register", json=user_data1)
        
        # Try to create duplicate
        user_data2 = {"username": "dupemail2", "email": "dupemail@example.com", "password": "TestPass123!"}
        response = auth_client.post("/api/v1/users", json=user_data2)
        assert response.status_code in [400, 403]
