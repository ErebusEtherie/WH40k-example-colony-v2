...
with open(
    r"tests\application\services\test_development_plan_service.py", "r", encoding="utf-8"
) as f:
    content = f.read()
...
with open(
    r"tests\application\services\test_development_plan_service.py", "w", encoding="utf-8"
) as f:
    f.write(content)
