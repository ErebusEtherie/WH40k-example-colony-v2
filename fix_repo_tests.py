...
with open(
    r"tests\adapters\persistence\test_development_plan_repository.py", "r", encoding="utf-8"
) as f:
    content = f.read()
...
with open(
    r"tests\adapters\persistence\test_development_plan_repository.py", "w", encoding="utf-8"
) as f:
    f.write(content)
